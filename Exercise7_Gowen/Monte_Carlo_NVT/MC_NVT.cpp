...
{ 
  ...
  if(restart=="false")
  {
    ...
    cout << endl;
    cout << "Classic Lennard-Jones fluid        " << endl;
    cout << "Monte Carlo simulation in NVE ensemble  " << endl << endl;
    cout << "Interatomic potential v(r) = 4 * [(1/r)^12 - (1/r)^6]" << endl << endl;
    cout << "The program uses Lennard-Jones units " << endl;
...
void Equilibrate_system(int equilibration_steps)
{
  ...
  if(restart=="true")
  {
    cout << "" << endl;
    cout << "--------------------------------------------------------------------------------------------" << endl;
    cout << "(restart==\"true\") Equilibration phase. Running " << equilibration_steps 
         << " steps to equilibrate the system" << endl;
    cout << "" << endl;
    ...
    set_restart("true","false");                           // changing restart value true->false
  }
  else{ cout << "(restart==\"false\") skipping equilibration" << endl; }
...
void Move(void)
{
  ...
  for(int i=0; i<npart; ++i)
  {
    ...
    //Metropolis test
    p = exp(beta*(energy_old-energy_new));    // Acceptance probability
    if(p >= rnd.Rannyu())
    {
      //Update
      x[o] = xnew;
